...
allprojects {
    group = "org.openprojectx.spark.boot"
}
                ...
                if (findByName("mavenJava") == null) {
                    create<MavenPublication>("mavenJava") {
                        ...
                        pom {
                            ...
                            scm {
                                url.set("https://github.com/OpenProjectX/spark-boot")
                                connection.set("scm:git:https://github.com/OpenProjectX/spark-boot.git")
                                developerConnection.set("scm:git:ssh://git@github.com:OpenProjectX/spark-boot.git")
                            }
                        }
                    }
                }
